    ...
    for ($i = 0; $i < $len; $i++) {
        ...
        if ($m_state == 0) {
            ...
            if (0 == (0x80 & $in)) {
                ...
                trigger_error('\Phalcana\UTF8::toUnicode: Illegal sequence identifier in UTF-8 at byte '.$i, E_USER_WARNING);
                return false;
            }
        } else {
            ...
            if (0x80 == (0xC0 & $in)) {
                ...
                if (0 == --$m_state) {
                    ...
                    if (((2 == $m_bytes) && ($m_ucs4 < 0x0080)) ||
                        ...
                        ($m_ucs4 > 0x10FFFF)) {
                        trigger_error('\Phalcana\UTF8::toUnicode: Illegal sequence or codepoint in UTF-8 at byte '.$i, E_USER_WARNING);
                        return false;
                    }
                ...
                throw new UTF8_Exception("\Phalcana\UTF8::toUnicode: Incomplete multi-octet sequence in UTF-8 at byte ':byte'", array(
                    ':byte' => $i,
                ));
            }
        }
