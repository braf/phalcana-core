...
<div class="row-outer">
	<div class="inner text-center">
		...
		<h5  id="install" class="animated">Installation complete</h5>
		<p id="version" class="animated">
			Version: <strong><?php echo \Phalcana\Phalcana::VERSION .' '. ucfirst(\Phalcana\Phalcana::CODENAME) ?></strong><br/>
			Mode: <strong><?php switch (\Phalcana\Phalcana::$mode) {
				case \Phalcana\Phalcana::PRODUCTION:
					echo 'Production';
					break;
				case \Phalcana\Phalcana::STAGING:
					echo 'Staging';
					break;
				case \Phalcana\Phalcana::TESTING:
					echo 'Testing';
					break;
				case \Phalcana\Phalcana::DEVELOPMENT:
					echo 'Development';
					break;
...
<script type="text/javascript">
		document.addEventListener("DOMContentLoaded", function (event) {
			...
			setTimeout(function () {
				f.className = f.className + " fadeIn";
			},1600);
		});
</script>
