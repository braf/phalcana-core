...
class UTF8Test extends TestCase
{
    ...
    /**
     * Provides test data for test_isAscii()
     */
    public function provider_isAscii()
    {
        return array(
            array("\0", true),
            array("\$eno\r", true),
     ...
     *
     * @test
     * @dataProvider provider_isAscii
     */
    public function test_isAscii($input, $expected)
    {
        $this->assertSame($expected, UTF8::isAscii($input));
    }

    /**
     * Provides test data for test_stripAsciiCtrl()
     */
    public function provider_stripAsciiCtrl()
    {
        return array(
            array("\0", ''),
            array("→foo\021", '→foo'),
    ...
    /**
     * Provides test data for test_stripNonAscii()
     */
    public function provider_stripNonAscii()
    {
        return array(
    ...
    /**
     * Tests UTF8::stripNonAscii
     *
     * @test
     * @dataProvider provider_stripNonAscii
     */
    public function test_stripNonAscii($input, $expected)
    {
        $this->assertSame($expected, UTF8::stripNonAscii($input));
    }

    /**
     * Provides test data for test_transliterateToAscii()
     */
    public function provider_transliterateToAscii()
    {
        return array(
    ...
    /**
     * Provides test data for test_substrReplace()
     */
    public function provider_substrReplace()
    {
        return array(
    ...
    /**
     * Tests UTF8::substrReplace
     *
     * @test
     * @dataProvider provider_substrReplace
     */
    public function test_substrReplace($input, $replacement, $offset, $length, $expected)
    {
        $this->assertSame($expected, UTF8::substrReplace($input, $replacement, $offset, $length));
    }
    ...
    /**
     * Provides test data for test_strIreplace()
     */
    public function provider_strIreplace()
    {
        return array(
    ...
    /**
     * Tests UTF8::strIreplace
     *
     * @test
     * @dataProvider provider_strIreplace
     */
    public function test_strIreplace($search, $replace, $subject, $expected)
    {
        $this->assertSame($expected, UTF8::strIreplace($search, $replace, $subject));
    }
    ...
    /**
     * Provides test data for test_strPad()
     */
    public function provider_strPad()
    {
        return array(
     ...
     *
     * @test
     * @dataProvider provider_strPad
     */
    public function test_strPad($input, $length, $pad, $type, $expected)
    {
        $this->assertSame($expected, UTF8::strPad($input, $length, $pad, $type));
    }

        /**
     * Tests UTF8::strPad error
     *
     * @test
     * @expectedException Phalcana\Exceptions\UTF8
     */
    public function test_strPad_error()
    {
        UTF8::strPad('Cocoñùт', 10, 'š', 15,  'šCocoñùтšš');
    }

    /**
     * Provides test data for test_strSplit()
     */
    public function provider_strSplit()
    {
        return array(
