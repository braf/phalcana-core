...
class DateTest extends TestCase
{
    ...
    /**
     * Provides test data for testFormattedTime()
     *
     * @return array
     */
    public function providerFormattedTime()
    {
        return array(
    ...
    /**
     * Tests Date::formattedTime()
     *
     * @test
     * @dataProvider providerFormattedTime
     * @covers Date::formattedTime
     * @ticket 3035 3902
     ...
     */
    public function testFormattedTime($expected, $datetime_str, $timestamp_format = null, $timezone = null)
    {
        $timestamp = Date::formattedTime($datetime_str, $timestamp_format, $timezone);
    ...
    /**
     * Provides test data to test_fuzzySpan
     *
     ...
     * @return array Test Data
     */
    public function provider_fuzzySpan()
    {
        $now = time();
     ...
     *
     * @test
     * @dataProvider provider_fuzzySpan
     * @param string  $expected        Expected output
     * @param integer $timestamp       Timestamp to use
     * @param integer $local_timestamp The local timestamp to use
     */
    public function test_fuzzySpan($expected, $timestamp, $local_timestamp)
    {
        $this->assertSame(
            $expected,
            Date::fuzzySpan($timestamp, $local_timestamp)
        );
    }
