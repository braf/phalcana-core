...
class TextTest extends TestCase
{
    ...
    public function test_auto_para_encloses_slot_in_paragraph()
    {
        ...
        $this->assertSame('<p>'.$text.'</p>', Text::autoP($text));
    }
    ...
    {
        $this->assertSame($expected, Text::limitWords($str, $limit, $end_char));
    }
    ...
    {
        $this->assertSame($expected, Text::limitChars($str, $limit, $end_char, $preserve_words));
    }
    ...
    {
        $this->assertSame($expected, Text::reduceSlashes($str));
    }
    ...
    /**
     * This checks that autoLinkEmails() respects word boundaries and does not
    ...
    public function test_auto_link_emails_respects_word_boundaries()
    {
        ...
        $this->assertFalse(strpos('vice', Text::autoLinkEmails($original)));
    }
    ...
    /**
     * Runs tests for Test::autoLinkUrls
     *
     * @test
    ...
    {
        $this->assertSame($expected, Text::autoLinkUrls($text));
    }
    ...
    {
        $browser = Text::userAgent($userAgent, 'browser');
    ...
    {
        $version = Text::userAgent($userAgent, 'version');
    ...
    {
        $bot = Text::userAgent('Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)', 'robot');
    ...
    {
        $platform = Text::userAgent($userAgent, 'platform');
