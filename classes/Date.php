 ...
 */
class Date extends \Phalcon\Di\Injectable
{
     ...
     * @param   integer $localTimestamp    "local" timestamp, defaults to time()
     * @return  string
     */
    public static function fuzzySpan($timestamp, $localTimestamp = null)
    {
        $localTimestamp = ($localTimestamp === null) ? time() : (int) $localTimestamp;

        // Determine the difference in seconds
        $offset = abs($localTimestamp - $timestamp);
     ...
     * @return  string
     */
    public static function formattedTime($datetime_str = 'now', $timestampFormat = null, $timezone = null)
    {
        $timestampFormat = ($timestampFormat == null) ? self::$timestampFormat : $timestampFormat;
