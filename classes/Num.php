 ...
 */
class Num extends \Phalcon\Di\Injectable
{
    ...
    public static function bytes($size)
    {
        ...
        // Construct an || list of byte units for the regex
        $accepted = implode('|', array_keys(self::$byteUnits));
        ...
        $bytes = $size * pow(2, self::$byteUnits[$unit]);
