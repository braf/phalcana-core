 ...
 */
class Inflector extends \Phalcon\Di\Injectable
{
     ...
     * case, please report [an issue](http://dev.kohanaphp.com/projectsself::$3/issues).
     *
    ...
    public static function uncountable($str)
    {
        if (self::$uncountable === null) {
            // Cache uncountables
            self::$uncountable = \Phalcana\Phalcana::$di->get('config')->load('inflector')->uncountable->toArray();
    ...
    public static function singular($str, $count = null)
    {
        ...
        if (empty(self::$irregular)) {
            ...
            self::$irregular = \Phalcana\Phalcana::$di->get('config')->load('inflector')->irregular->toArray();
        }
