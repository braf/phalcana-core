 ...
 */
class Arr extends \Phalcon\Di\Injectable
{
    ...
    */
    ...
    public static function extract($array, array $paths, $default = null)
    {
        ...
        foreach ($paths as $path) {
            self::setPath($found, $path, Arr::path($array, $path, $default));
        }
     ...
     *
     *     // Apply self::filter to every element in the array
     *     $array = Arr::map(array(array($this,'filter')), $array);
     *
     *     // Apply strip_tags and self::filter to every element
